    ...
    return (
      <div className="mainDisplay panelContainer">
        <div className="panel half heatingPanel">
          ...
          <h3>Temperature</h3>
          <TemperatureDisplay zone="upstairs" temp={this.props.data.temperature['house-upstairs']} settemp={this.props.data.heating['upstairs-set-temp']} state={this.props.data.heating['upstairs-state']} />
          <TemperatureDisplay zone="downstairs" temp={this.props.data.temperature['house-downstairs']} settemp={this.props.data.heating['downstairs-set-temp']} state={this.props.data.heating['downstairs-state']} />
